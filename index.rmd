...
knitr::include_graphics("images/Competncias.png")
```
...
Última atualização em `r Sys.Date()`. A versão mais recente está [disponível aqui](https://beatrizmilz.github.io/resume/index.pdf).
:::
